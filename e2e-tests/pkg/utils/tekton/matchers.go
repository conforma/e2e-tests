...
func (matcher *TaskRunResultMatcher) FailureMessage(actual interface{}) string {
...
func (matcher *TaskRunResultMatcher) Match(actual interface{}) (bool, error) {
	tr, ok := actual.(tektonpipeline.TaskRunResult)
	if !ok {
...
func (matcher *TaskRunResultMatcher) NegatedFailureMessage(actual interface{}) string {
...
func DidTaskRunSucceed(tr interface{}) bool {
	...
	case *tektonpipeline.TaskRunStatus:
		...
		return tr.GetCondition(apis.ConditionSucceeded).IsTrue()
	}
	return false
}
